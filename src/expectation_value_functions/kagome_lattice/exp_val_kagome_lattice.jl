function exp_val_energy_generic_kagome_lattice_model(env_arr, loc, loc_d, Ham_parameters, Pattern_arr; model = :Heisenberg_square, Space_type = ℂ)
...
function exp_val_observables_generic_kagome_lattice_model(env_arr, loc, loc_d, Ham_parameters, Pattern_arr; model = :Heisenberg_square, Space_type = ℂ, loc_terms = true, nn_terms = true)
    ...
    #if nn obs are needed we add them here.
